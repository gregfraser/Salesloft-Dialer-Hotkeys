...
node behaviour.mjs   # the Not in Service flow, the pane, the not-armed state (68)
...
`queue` puts other people's identical remove controls ahead of the contact's. See
